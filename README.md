...
- 🤖 I build AI apps using **LangChain, RAG, LLMs and Agentic AI**
- 📊 I turn data into decisions using **Python, SQL and Power BI**
- 🏆 Built NLP classifier with **85% accuracy & 0.95 F1-score**
- 🎓 Certified in **Microsoft Azure AI & NASSCOM Data Science**
- 🟢 **Open to Work** — Data Scientist · AI Engineer · Data Analyst
